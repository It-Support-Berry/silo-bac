 ...
 * @ORM\Table(name="archives", indexes={@ORM\Index(columns={"codejde", "matiere", "lot1", "lot2", "commentaire"}, flags={"fulltext"})})
 */
class Archives
{
    ...
    /**
     * 1 = remplacement du bac en cours
     * 2 = création
     * 3 MAJ dun bac 
     * @ORM\Column(type="integer")
     */
    private $typeOfAction;
    ...
    */
    ...
    public function getTypeOfAction(): ?int
    {
        return $this->typeOfAction;
    }

    public function setTypeOfAction(int $typeOfAction): self
    {
